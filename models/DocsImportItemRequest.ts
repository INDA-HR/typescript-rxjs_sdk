...
/**
 * @export
 * @interface DocsImportItemRequest
 */
export interface DocsImportItemRequest {
    /**
     * @type {string}
     * @memberof DocsImportItemRequest
     */
    Bucket: string;
    /**
     * @type {Array<DocsBucketItem>}
     * @memberof DocsImportItemRequest
     */
    Files: Array<DocsBucketItem>;
    /**
     * @type {AwsCredentials}
     * @memberof DocsImportItemRequest
     */
