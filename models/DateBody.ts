...
export interface DateBody {
    /**
     * Optional. Starting date of the specified range of interest in the format *yyyy-mm-dd[ HH:MM:ss]*.
     * @type {string}
     * @memberof DateBody
     */
    Begin?: string;
    /**
     * Optional. Ending date of the specified range of interest in the format *yyyy-mm-dd[ HH:MM:ss]*.
     * @type {string}
     * @memberof DateBody
     */
    End?: string;
