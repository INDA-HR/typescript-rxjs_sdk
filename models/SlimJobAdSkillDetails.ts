...
/**
 * @export
 * @interface SlimJobAdSkillDetails
 */
export interface SlimJobAdSkillDetails {
    /**
     * @type {Array<TextPosition>}
     * @memberof SlimJobAdSkillDetails
     */
     ...
     * @memberof SlimJobAdSkillDetails
     */
    Category?: SlimJobAdSkillDetailsCategoryEnum;
    /**
     * @type {number}
     * @memberof SlimJobAdSkillDetails
     */
 ...
 * @enum {string}
 */
export enum SlimJobAdSkillDetailsCategoryEnum {
    Hard = 'hard',
    Soft = 'soft',
    It = 'IT',
    Language = 'language'
