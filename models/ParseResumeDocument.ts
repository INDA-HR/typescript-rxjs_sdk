...
/**
 * @export
 * @interface ParseResumeDocument
 */
export interface ParseResumeDocument {
    /**
     * @type {string}
     * @memberof ParseResumeDocument
     */
    PlainText?: string;
    /**
     ...
     * @memberof ParseResumeDocument
     */
    Language?: ParseResumeDocumentLanguageEnum;
    /**
     * @type {string}
     * @memberof ParseResumeDocument
     */
 ...
 * @enum {string}
 */
export enum ParseResumeDocumentLanguageEnum {
    It = 'it',
    En = 'en',
    Fr = 'fr',
    Pt = 'pt'
