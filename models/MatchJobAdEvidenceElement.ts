...
/**
 * @export
 * @interface MatchJobAdEvidenceElement
 */
export interface MatchJobAdEvidenceElement {
    /**
     * @type {string}
     * @memberof MatchJobAdEvidenceElement
     */
    ID: string;
    /**
     * @type {RequiredAndPreferredMatchJobAdEvidenceEducation}
     * @memberof MatchJobAdEvidenceElement
     */
    Education: RequiredAndPreferredMatchJobAdEvidenceEducation;
    /**
     * @type {MatchJobAdEvidenceExperience}
     * @memberof MatchJobAdEvidenceElement
     */
    Experience: MatchJobAdEvidenceExperience;
    /**
     * @type {RequiredAndPreferredListMatchJobAdEvidenceSkill}
     * @memberof MatchJobAdEvidenceElement
     */
    Skills: RequiredAndPreferredListMatchJobAdEvidenceSkill;
    /**
     * @type {Array<MatchJobAdEvidenceJobTitle>}
     * @memberof MatchJobAdEvidenceElement
     */
    JobTitles: Array<MatchJobAdEvidenceJobTitle>;
}
