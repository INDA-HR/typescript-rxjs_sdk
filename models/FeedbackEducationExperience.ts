...
/**
 * @export
 * @interface FeedbackEducationExperience
 */
export interface FeedbackEducationExperience {
    /**
     * @type {BaseDuration}
     * @memberof FeedbackEducationExperience
     */
    Duration?: BaseDuration;
    /**
     * @type {FeedbackEducationTitle}
     * @memberof FeedbackEducationExperience
     */
    EducationTitle?: FeedbackEducationTitle;
    /**
     * @type {FeedbackFieldOfStudy}
     * @memberof FeedbackEducationExperience
     */
    FieldOfStudy?: FeedbackFieldOfStudy;
    /**
     * @type {FinalGrade}
     * @memberof FeedbackEducationExperience
     */
     ...
     * @memberof FeedbackEducationExperience
     */
    EducationLevelCode?: ResumeEducationExperiencesEducationLevelCode;
    /**
     * @type {Description}
     * @memberof FeedbackEducationExperience
     */
    ...
    Ongoing?: Ongoing;
    /**
     * @type {ResumeLocationsLocation}
     * @memberof FeedbackEducationExperience
     */
    Location?: ResumeLocationsLocation;
    /**
     * @type {FeedbackOrganization}
     * @memberof FeedbackEducationExperience
     */
    ...
    Courses?: Array<Text>;
    /**
     * Unique identifier for the current experience.
     * @type {string}
     * @memberof FeedbackEducationExperience
     */
    ID?: string;
