...
/**
 * @export
 * @interface UpskillingRequest
 */
export interface UpskillingRequest {
    /**
     * Origin occupation for which transition recommendations will be generated.
     * @type {string}
     * @memberof UpskillingRequest
     */
     ...
     * @memberof UpskillingRequest
     */
    TransitionType: UpskillingRequestTransitionTypeEnum;
    /**
 ...
 * @enum {string}
 */
export enum UpskillingRequestTransitionTypeEnum {
    Viable = 'viable',
    Desirable = 'desirable',
    SafeDesirable = 'safe_desirable',
    StrictlySafeDesirable = 'strictly_safe_desirable'
}
