...
/**
 * @export
 * @interface OccupationSkillsComparisonRequest
 */
export interface OccupationSkillsComparisonRequest {
    /**
     * Origin occupation involved in the considered career transition.
     * @type {string}
     * @memberof OccupationSkillsComparisonRequest
     */
    OriginOccupation: string;
    /**
     * Destination occupation involved in the considered career transition.
     * @type {string}
     * @memberof OccupationSkillsComparisonRequest
     */
    DestinationOccupation: string;
    /**
     * Which skills from origin occupation to use.
     * @type {string}
     * @memberof OccupationSkillsComparisonRequest
     */
    SkillMatch: OccupationSkillsComparisonRequestSkillMatchEnum;
}
 ...
 * @enum {string}
 */
export enum OccupationSkillsComparisonRequestSkillMatchEnum {
    Optional = 'optional',
    Essential = 'essential'
}
