...
/**
 * @export
 * @interface SemanticCommonSimpleTerm
 */
export interface SemanticCommonSimpleTerm {
    /**
     * The desired term(s) to search for.
     * @type {string}
     * @memberof SemanticCommonSimpleTerm
     */
    Term: string;
    /**
     * Optional. Exclude documents that match this term from the result, which is equivalent to the boolean NOT operator.
     * @type {boolean}
     * @memberof SemanticCommonSimpleTerm
     */
    Exclude?: boolean;
