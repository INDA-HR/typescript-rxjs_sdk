...
/**
 * @export
 * @interface EscoJobtitleResponse
 */
export interface EscoJobtitleResponse {
    /**
     * Number of elements in a search query.
     * @type {number}
     * @memberof EscoJobtitleResponse
     */
    Hits?: number;
    /**
     * This field shows the result of the ESCO classification.
     * @type {Array<OptionalEscoOccupationMatch>}
     * @memberof EscoJobtitleResponse
     */
    ESCOClassification?: Array<OptionalEscoOccupationMatch>;
}
