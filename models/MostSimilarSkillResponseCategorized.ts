...
/**
 * @export
 * @interface MostSimilarSkillResponseCategorized
 */
export interface MostSimilarSkillResponseCategorized {
    /**
     * @type {EscoCommonSkill}
     * @memberof MostSimilarSkillResponseCategorized
     */
    Skill: EscoCommonSkill;
}
