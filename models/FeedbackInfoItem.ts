...
/**
 * @export
 * @interface FeedbackInfoItem
 */
export interface FeedbackInfoItem {
    /**
     * @type {FeedbackExtractionItem}
     * @memberof FeedbackInfoItem
     */
    ParseResumeOutput: FeedbackExtractionItem;
    /**
     * @type {FeedbackBaseItem}
     * @memberof FeedbackInfoItem
     */
    OutputCorrected: FeedbackBaseItem;
}
