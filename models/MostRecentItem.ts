...
/**
 * @export
 * @interface MostRecentItem
 */
export interface MostRecentItem {
    /**
     * @type {ResumeCommonMinimalData}
     * @memberof MostRecentItem
     */
    Data?: ResumeCommonMinimalData;
    /**
     * @type {ResumeCommonPublicMetadata}
     * @memberof MostRecentItem
     */
    Metadata: ResumeCommonPublicMetadata;
    /**
     * @type {MinimalPublicAttachments}
     * @memberof MostRecentItem
     */
    Attachments: MinimalPublicAttachments;
    /**
     * @type {string}
     * @memberof MostRecentItem
     */
