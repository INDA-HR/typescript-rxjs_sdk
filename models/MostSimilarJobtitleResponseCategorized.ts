...
/**
 * @export
 * @interface MostSimilarJobtitleResponseCategorized
 */
export interface MostSimilarJobtitleResponseCategorized {
    /**
     * @type {Jobtitle}
     * @memberof MostSimilarJobtitleResponseCategorized
     */
    Jobtitle: Jobtitle;
}
