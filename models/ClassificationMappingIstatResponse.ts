...
/**
 * @export
 * @interface ClassificationMappingIstatResponse
 */
export interface ClassificationMappingIstatResponse {
    /**
     * This field shows the ISTAT occupation code.
     * @type {string}
     * @memberof ClassificationMappingIstatResponse
     */
    ISTATCode: string;
    /**
     * This field shows the ISTAT occupation.
     * @type {string}
     * @memberof ClassificationMappingIstatResponse
     */
    ISTATOccupation?: string;
    /**
     * This field shows the mapping to O*NET.
     * @type {Array<OnetMapping>}
     * @memberof ClassificationMappingIstatResponse
     */
    MappingONET?: Array<OnetMapping>;
    /**
     * This field shows the mapping to ISCO.
     * @type {Array<IscoMapping>}
     * @memberof ClassificationMappingIstatResponse
     */
    MappingISCO?: Array<IscoMapping>;
    /**
     * This field shows the mapping to ESCO.
     * @type {Array<EscoMapping>}
     * @memberof ClassificationMappingIstatResponse
     */
    MappingESCO?: Array<EscoMapping>;
}
