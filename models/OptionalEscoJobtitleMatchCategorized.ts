...
/**
 * @export
 * @interface OptionalEscoJobtitleMatchCategorized
 */
export interface OptionalEscoJobtitleMatchCategorized {
    /**
     * This field shows the ESCO code.
     * @type {string}
     * @memberof OptionalEscoJobtitleMatchCategorized
     */
    Code?: string;
    /**
     ...
     * @type {Array<Jobfunctions>}
     * @memberof OptionalEscoJobtitleMatchCategorized
     */
    JobFunctions?: Array<Jobfunctions>;
}
