...
/**
 * @export
 * @interface OptionalRequiredAndPreferredDurationRange
 */
export interface OptionalRequiredAndPreferredDurationRange {
    /**
     * @type {DurationRange}
     * @memberof OptionalRequiredAndPreferredDurationRange
     */
