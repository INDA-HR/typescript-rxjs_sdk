...
/**
 * @export
 * @interface FoundCandidatesResponse
 */
export interface FoundCandidatesResponse {
    /**
     * Total number of elements in a certain index.
     * @type {number}
     * @memberof FoundCandidatesResponse
     */
    Total?: number;
    /**
    ...
    SearchID?: string;
    /**
     * @type {Array<SearchCandidateElement>}
     * @memberof FoundCandidatesResponse
     */
    Out: Array<SearchCandidateElement>;
}
