...
/**
 * @export
 * @interface OptionalResumeAttachmentLanguage
 */
export interface OptionalResumeAttachmentLanguage {
    /**
     * Language of the attachment.
     * @type {string}
     * @memberof OptionalResumeAttachmentLanguage
     */
    Language?: OptionalResumeAttachmentLanguageLanguageEnum;
}
 ...
 * @enum {string}
 */
export enum OptionalResumeAttachmentLanguageLanguageEnum {
    Fr = 'fr',
    Pt = 'pt',
    It = 'it',
    En = 'en',
