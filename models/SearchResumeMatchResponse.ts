...
/**
 * @export
 * @interface SearchResumeMatchResponse
 */
export interface SearchResumeMatchResponse {
    /**
     * Total number of elements in a certain index.
     * @type {number}
     * @memberof SearchResumeMatchResponse
     */
    Total?: number;
    /**
     * Number of elements in a search query.
     * @type {number}
     * @memberof SearchResumeMatchResponse
     */
    Hits?: number;
    /**
     * This ID is used in order to retrieve the result of a certain search query or scroll to the next search batch.
     * @type {string}
     * @memberof SearchResumeMatchResponse
     */
    SearchID?: string;
    /**
     * @type {Array<SearchResumeElement>}
     * @memberof SearchResumeMatchResponse
     */
    Out: Array<SearchResumeElement>;
}
