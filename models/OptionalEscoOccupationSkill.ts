...
/**
 * @export
 * @interface OptionalEscoOccupationSkill
 */
export interface OptionalEscoOccupationSkill {
    /**
     * This field shows the concept type according with the ESCO classification.
     * @type {string}
     * @memberof OptionalEscoOccupationSkill
     */
    ConceptType?: string;
    /**
     * This field shows the skill preferred label according with the ESCO classification.
     * @type {string}
     * @memberof OptionalEscoOccupationSkill
     */
    PreferredLabel?: string;
    /**
     * This field shows the skill alternative labels according with the ESCO classification.
     * @type {string}
     * @memberof OptionalEscoOccupationSkill
     */
    AltLabels?: string;
    /**
     * This field shows the skill description according with the ESCO classification.
     * @type {string}
     * @memberof OptionalEscoOccupationSkill
     */
    Description?: string;
