...
/**
 * @export
 * @interface JobAdFullTextSearch
 */
export interface JobAdFullTextSearch {
    /**
     * List of terms to search in documents.
     * @type {Array<JobadRequestsSimpleTerm>}
     * @memberof JobAdFullTextSearch
     */
    QueryTerms: Array<JobadRequestsSimpleTerm>;
    /**
     * @type {QueryFilters}
     * @memberof JobAdFullTextSearch
     */
