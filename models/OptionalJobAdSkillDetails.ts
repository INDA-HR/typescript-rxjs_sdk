...
/**
 * @export
 * @interface OptionalJobAdSkillDetails
 */
export interface OptionalJobAdSkillDetails {
    /**
     * @type {Array<TextPosition>}
     * @memberof OptionalJobAdSkillDetails
     */
     ...
     * @memberof OptionalJobAdSkillDetails
     */
    Category?: OptionalJobAdSkillDetailsCategoryEnum;
    /**
 ...
 * @enum {string}
 */
export enum OptionalJobAdSkillDetailsCategoryEnum {
    Hard = 'hard',
    Soft = 'soft',
    It = 'IT',
    Language = 'language'
