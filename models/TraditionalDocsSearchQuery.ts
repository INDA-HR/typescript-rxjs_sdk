...
/**
 * @export
 * @interface TraditionalDocsSearchQuery
 */
export interface TraditionalDocsSearchQuery {
    /**
     * List of terms to search in documents
     * @type {Array<SemanticCommonSimpleTerm>}
     * @memberof TraditionalDocsSearchQuery
     */
    QueryTerms: Array<SemanticCommonSimpleTerm>;
    /**
     * @type {QueryFilters}
     * @memberof TraditionalDocsSearchQuery
     */
