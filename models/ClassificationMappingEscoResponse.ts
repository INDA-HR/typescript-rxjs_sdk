...
/**
 * @export
 * @interface ClassificationMappingEscoResponse
 */
export interface ClassificationMappingEscoResponse {
    /**
     * This field shows the ESCO occupation code.
     * @type {string}
     * @memberof ClassificationMappingEscoResponse
     */
    ESCOCode: string;
    /**
     * This field shows the ESCO occupation.
     * @type {string}
     * @memberof ClassificationMappingEscoResponse
     */
