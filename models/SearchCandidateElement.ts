...
/**
 * @export
 * @interface SearchCandidateElement
 */
export interface SearchCandidateElement {
    /**
     * Normalized score. Min Score is 0 and Max Score is 1.
     * @type {number}
     * @memberof SearchCandidateElement
     */
    Score: number;
    /**
     * Position into the ranking. Min Rank is 0.
     * @type {number}
     * @memberof SearchCandidateElement
     */
    Rank: number;
    ...
    ID: string;
    /**
     * @type {ResumeCommonMinimalData}
     * @memberof SearchCandidateElement
     */
    Data?: ResumeCommonMinimalData;
}
