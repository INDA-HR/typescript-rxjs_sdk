...
/**
 * @export
 * @interface OptionalInstitutionalHospitalDetails
 */
export interface OptionalInstitutionalHospitalDetails {
    /**
     * Institutional Hospital description.
     * @type {string}
     * @memberof OptionalInstitutionalHospitalDetails
     */
