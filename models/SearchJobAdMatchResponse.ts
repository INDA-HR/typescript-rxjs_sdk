...
/**
 * @export
 * @interface SearchJobAdMatchResponse
 */
export interface SearchJobAdMatchResponse {
    /**
     * Total number of elements in a certain index.
     * @type {number}
     * @memberof SearchJobAdMatchResponse
     */
    Total?: number;
    /**
    ...
    SearchID?: string;
    /**
     * @type {Array<SearchJobAdElement>}
     * @memberof SearchJobAdMatchResponse
     */
    Out: Array<SearchJobAdElement>;
}
