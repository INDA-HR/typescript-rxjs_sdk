...
/**
 * @export
 * @interface RelocationBoolBaseModel
 */
export interface RelocationBoolBaseModel {
    /**
     * Whether or not the option is possible.
     * @type {boolean}
     * @memberof RelocationBoolBaseModel
     */
    IsPossible?: boolean;
    /**
    ...
    IsMandatory?: boolean;
    /**
     * Whether or not the the company is willing to pay relocation expenses.
     * @type {boolean}
     * @memberof RelocationBoolBaseModel
     */
    IsAllExpensesPaid?: boolean;
}
