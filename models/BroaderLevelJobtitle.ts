...
/**
 * @export
 * @interface BroaderLevelJobtitle
 */
export interface BroaderLevelJobtitle {
    /**
     * This field shows the code according with the ISCO classification.
     * @type {string}
     * @memberof BroaderLevelJobtitle
     */
    ISCOcode?: string;
    /**
     * This field shows the label according with the ISCO classification.
     * @type {string}
     * @memberof BroaderLevelJobtitle
     */
    Label?: string;
