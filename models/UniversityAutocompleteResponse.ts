...
/**
 * @export
 * @interface UniversityAutocompleteResponse
 */
export interface UniversityAutocompleteResponse {
    /**
     * The term queried in the request.
     * @type {string}
     * @memberof UniversityAutocompleteResponse
     */
    Term: string;
    /**
     * @type {Array<UniversityAutocomplete>}
     * @memberof UniversityAutocompleteResponse
     */
    Universities: Array<UniversityAutocomplete>;
}
