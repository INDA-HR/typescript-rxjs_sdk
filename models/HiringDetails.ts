...
export interface HiringDetails {
    /**
     * The application date keeps track of the first time the candidate applies to a Job Advertisement. It is a replica of the hiring pipeline step corresponding to the status \'APPLIED\'. Format: \'YYYY-MM-DD\'.
     * @type {string}
     * @memberof HiringDetails
     */
    ApplicationDate: string;
    /**
     * The hiring date keeps track of the date in which the candidate has been hired. It is a replica of the hiring pipeline step corresponding to the status \'HIRED\'. Format: \'YYYY-MM-DD\'.
     * @type {string}
     * @memberof HiringDetails
     */
    HiringDate?: string;
     ...
     * @memberof HiringDetails
     */
    HiringPipeline?: Array<HiringPipelineStage>;
}
