...
/**
 * @export
 * @interface JobTitleHeaderDetails
 */
export interface JobTitleHeaderDetails {
    /**
     * @type {Array<TextPosition>}
     * @memberof JobTitleHeaderDetails
     */
    ...
    /**
     * Weight of the main job title. Used for mathing purposes.
     * @type {number}
     * @memberof JobTitleHeaderDetails
     */
    Weight?: number;
