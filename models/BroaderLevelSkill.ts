...
/**
 * @export
 * @interface BroaderLevelSkill
 */
export interface BroaderLevelSkill {
    /**
     * This field shows the URI according with the ESCO classification.
     * @type {string}
     * @memberof BroaderLevelSkill
     */
    URI?: string;
    /**
     * This field shows the label according with the ESCO classification.
     * @type {string}
     * @memberof BroaderLevelSkill
     */
    Label?: string;
