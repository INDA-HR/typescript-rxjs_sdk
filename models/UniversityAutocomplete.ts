...
/**
 * @export
 * @interface UniversityAutocomplete
 */
export interface UniversityAutocomplete {
    /**
     * @type {string}
     * @memberof UniversityAutocomplete
     */
    ID: string;
    /**
     * University Name. Generally stored as roman characters.
     * @type {string}
     * @memberof UniversityAutocomplete
     */
    Name?: string;
    /**
     * University Alternative Name. It may contain non-roman characters as well as the University Name in English.
     * @type {string}
     * @memberof UniversityAutocomplete
     */
    AltName?: string;
