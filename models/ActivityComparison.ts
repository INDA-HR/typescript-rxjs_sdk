...
export interface ActivityComparison {
    /**
     * This field shows the skill category label according with the ESCO classification.
     * @type {string}
     * @memberof ActivityComparison
     */
    Title?: string;
    /**
     * This field shows the skill category code according with the ESCO classification.
     * @type {string}
     * @memberof ActivityComparison
     */
    Code?: string;
    /**
     * This field shows the weight of the skill category associated with origin occupation.
     * @type {number}
     * @memberof ActivityComparison
     */
    Origin?: number;
    /**
     * This field shows the weight of the skill category associated with destination occupation.
     * @type {number}
     * @memberof ActivityComparison
     */
    Destination?: number;
    /**
     * This field shows the difference between the weights of the origin and destination occupations.
     * @type {number}
     * @memberof ActivityComparison
     */
    Dif?: number;
    /**
     * This field shows the absolute difference between the weights of the origin and destination occupations.
     * @type {number}
     * @memberof ActivityComparison
     */
    DifAbs?: number;
