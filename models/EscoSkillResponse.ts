...
/**
 * @export
 * @interface EscoSkillResponse
 */
export interface EscoSkillResponse {
    /**
     * Number of elements in a search query.
     * @type {number}
     * @memberof EscoSkillResponse
     */
    Hits?: number;
    /**
     * ESCO classification
     * @type {Array<OptionalEscoSkillMatch>}
     * @memberof EscoSkillResponse
     */
    ESCOClassification?: Array<OptionalEscoSkillMatch>;
}
