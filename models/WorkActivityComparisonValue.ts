...
/**
 * @export
 * @interface WorkActivityComparisonValue
 */
export interface WorkActivityComparisonValue {
    /**
     * @type {ESCOOccupationValue}
     * @memberof WorkActivityComparisonValue
     */
    ESCOClassification?: ESCOOccupationValue;
    /**
     * This field shows the list of the work activity comparison.
     * @type {Array<ActivityComparison>}
     * @memberof WorkActivityComparisonValue
     */
    ActivityComparison?: Array<ActivityComparison>;
}
