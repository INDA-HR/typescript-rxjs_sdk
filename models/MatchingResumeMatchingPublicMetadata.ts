...
/**
 * @export
 * @interface MatchingResumeMatchingPublicMetadata
 */
export interface MatchingResumeMatchingPublicMetadata {
    /**
     * Deprecated: use *src_lang* instead. Language of the *Resume.Data* entity fields.
     * @type {string}
     * @memberof MatchingResumeMatchingPublicMetadata
     */
    Language?: MatchingResumeMatchingPublicMetadataLanguageEnum;
}
 ...
 * @enum {string}
 */
export enum MatchingResumeMatchingPublicMetadataLanguageEnum {
    It = 'it',
    En = 'en',
    Es = 'es',
    Pt = 'pt',
