...
/**
 * @export
 * @interface OptionalAccreditationsDetails
 */
export interface OptionalAccreditationsDetails {
    /**
     * Link to accreditations descriptions.
     * @type {string}
     * @memberof OptionalAccreditationsDetails
     */
    URL?: string;
    /**
     * @type {Yearoffirstaccreditation}
     * @memberof OptionalAccreditationsDetails
     */
    YearOfFirstAccreditation?: Yearoffirstaccreditation;
    /**
     * List of other institutions the University is recognised by.
     * @type {Array<string>}
     * @memberof OptionalAccreditationsDetails
     */
    OtherAccreditations?: Array<string>;
}
