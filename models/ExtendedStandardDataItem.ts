...
/**
 * @export
 * @interface ExtendedStandardDataItem
 */
export interface ExtendedStandardDataItem {
    /**
     * Unique code which encodes same values in different languages
     * @type {string}
     * @memberof ExtendedStandardDataItem
     */
    Code: string;
    /**
    ...
    Value: string;
    /**
     * Value language in ISO 639-1 format
     * @type {string}
     * @memberof ExtendedStandardDataItem
     */
    Language: string;
    /**
     * Human readable mutable alternative code
     * @type {string}
     * @memberof ExtendedStandardDataItem
     */
    Label: string;
