...
/**
 * @export
 * @interface SkillsClassificationResponse
 */
export interface SkillsClassificationResponse {
    /**
     * @type {Array<SkillsResponsesSkill>}
     * @memberof SkillsClassificationResponse
     */
    Skills: Array<SkillsResponsesSkill>;
}
