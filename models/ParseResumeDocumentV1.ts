...
/**
 * @export
 * @interface ParseResumeDocumentV1
 */
export interface ParseResumeDocumentV1 {
    /**
     * @type {string}
     * @memberof ParseResumeDocumentV1
     */
    PlainText: string;
    /**
     ...
     * @memberof ParseResumeDocumentV1
     */
    Language: ParseResumeDocumentV1LanguageEnum;
    /**
     * @type {string}
     * @memberof ParseResumeDocumentV1
     */
 ...
 * @enum {string}
 */
export enum ParseResumeDocumentV1LanguageEnum {
    It = 'it',
    En = 'en',
    Fr = 'fr',
    Pt = 'pt'
