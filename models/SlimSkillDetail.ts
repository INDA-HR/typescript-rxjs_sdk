...
/**
 * @export
 * @interface SlimSkillDetail
 */
export interface SlimSkillDetail {
    /**
     * @type {OptionalSlimEscoSkillMatchCategorized}
     * @memberof SlimSkillDetail
     */
    ESCOClassification?: OptionalSlimEscoSkillMatchCategorized;
}
