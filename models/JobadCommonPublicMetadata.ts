...
/**
 * @export
 * @interface JobadCommonPublicMetadata
 */
export interface JobadCommonPublicMetadata {
    /**
     * Language of the *JobAd.Data* fields.
     * @type {string}
     * @memberof JobadCommonPublicMetadata
     */
    Language?: JobadCommonPublicMetadataLanguageEnum;
    /**
 ...
 * @enum {string}
 */
export enum JobadCommonPublicMetadataLanguageEnum {
    De = 'de',
    Pt = 'pt',
    Fr = 'fr',
    Es = 'es',
