...
/**
 * @export
 * @interface OptionalRequiredAndPreferredSeniorityValue
 */
export interface OptionalRequiredAndPreferredSeniorityValue {
    /**
     * @type {SeniorityValue}
     * @memberof OptionalRequiredAndPreferredSeniorityValue
     */
