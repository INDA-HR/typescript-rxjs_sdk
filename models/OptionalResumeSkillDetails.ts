...
/**
 * @export
 * @interface OptionalResumeSkillDetails
 */
export interface OptionalResumeSkillDetails {
    /**
     * @type {Array<TextPosition>}
     * @memberof OptionalResumeSkillDetails
     */
     ...
     * @memberof OptionalResumeSkillDetails
     */
    Category?: OptionalResumeSkillDetailsCategoryEnum;
    /**
 ...
 * @enum {string}
 */
export enum OptionalResumeSkillDetailsCategoryEnum {
    Hard = 'hard',
    Soft = 'soft',
    It = 'IT',
    Language = 'language'
