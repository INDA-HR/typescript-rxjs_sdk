...
/**
 * @export
 * @interface JobadCommonOptionalData
 */
export interface JobadCommonOptionalData {
    /**
     * @type {JobTitleHeader}
     * @memberof JobadCommonOptionalData
     */
    ...
    /**
     * CompanyID of the employer company.
     * @type {string}
     * @memberof JobadCommonOptionalData
     */
    EmployerID?: string;
     ...
     * @type {Array<JobadContactInfoContactInfo>}
     * @memberof JobadCommonOptionalData
     */
    ContactInfo?: Array<JobadContactInfoContactInfo>;
    /**
     * Locations of the opened position.
     * @type {Array<BaseLocationsLocation>}
     * @memberof JobadCommonOptionalData
     */
    JobLocations?: Array<BaseLocationsLocation>;
    /**
    ...
    /**
     * @type {JobAdRemoteWorking}
     * @memberof JobadCommonOptionalData
     */
    RemoteWorking?: JobAdRemoteWorking;
    /**
     * @type {Experience}
     * @memberof JobadCommonOptionalData
     */
    ...
    /**
     * @type {OptionalRequiredAndPreferredEducation}
     * @memberof JobadCommonOptionalData
     */
    ...
    Skills?: Skills;
    /**
     * @type {OptionalRequiredAndPreferredConListLanguages}
     * @memberof JobadCommonOptionalData
     */
    Languages?: OptionalRequiredAndPreferredConListLanguages;
    /**
     * Additional Job Titles related to the opened position.
     * @type {Array<OptionalJobAdJobTitle>}
     * @memberof JobadCommonOptionalData
     */
    RelatedJobTitles?: Array<OptionalJobAdJobTitle>;
    /**
     * @type {JobTitleEmployment}
     * @memberof JobadCommonOptionalData
     */
     ...
     * @memberof JobadCommonOptionalData
     */
    NumberOfOpenings?: ValueModelInt;
    /**
     * @type {JobadLinkLink}
     * @memberof JobadCommonOptionalData
     */
     ...
     * @type {Array<JobadLinkLink>}
     * @memberof JobadCommonOptionalData
     */
    AdvertisementSites?: Array<JobadLinkLink>;
    /**
     * @type {JobAdSalary}
     * @memberof JobadCommonOptionalData
     */
    ...
    /**
     * Offered benefits.
     * @type {Array<JobAdBenefit>}
     * @memberof JobadCommonOptionalData
     */
    Benefits?: Array<JobAdBenefit>;
    /**
     * @type {ValueModelDatetime}
     * @memberof JobadCommonOptionalData
     */
    ExpirationDate?: ValueModelDatetime;
    /**
     * @type {JobadCommonValueModelStr}
     * @memberof JobadCommonOptionalData
     */
