...
/**
 * @export
 * @interface GroupByAdvancedAPICalls
 */
export interface GroupByAdvancedAPICalls {
    /**
     * @type {{ [key: string]: SlimBaseResponse; }}
     * @memberof GroupByAdvancedAPICalls
     */
    Advanced?: { [key: string]: SlimBaseResponse; };
    /**
     * @type {{ [key: string]: SlimBaseResponse; }}
     * @memberof GroupByAdvancedAPICalls
     */
    NotAdvanced?: { [key: string]: SlimBaseResponse; };
}
