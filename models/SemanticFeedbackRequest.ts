...
export interface SemanticFeedbackRequest {
     ...
     * @type {Array<SearchTerm>}
     * @memberof SemanticFeedbackRequest
     */
    Evidence?: Array<SearchTerm>;
}
 ...
 * @enum {string}
 */
export enum SemanticFeedbackRequestFeedbackEnum {
    NUMBER_MINUS_1 = -1,
    NUMBER_0 = 0,
    NUMBER_1 = 1
}
