...
/**
 * @export
 * @interface MatchResumeEvidenceElement
 */
export interface MatchResumeEvidenceElement {
    /**
     * @type {string}
     * @memberof MatchResumeEvidenceElement
     */
    ID: string;
    /**
     * @type {MatchResumeEvidenceEducation}
     * @memberof MatchResumeEvidenceElement
     */
    Education: MatchResumeEvidenceEducation;
    /**
     * @type {MatchResumeEvidenceExperience}
     * @memberof MatchResumeEvidenceElement
     */
    Experience: MatchResumeEvidenceExperience;
    /**
     * @type {Array<MatchResumeEvidenceSkill>}
     * @memberof MatchResumeEvidenceElement
     */
    Skills: Array<MatchResumeEvidenceSkill>;
    /**
     * @type {Array<MatchResumeEvidenceJobTitle>}
     * @memberof MatchResumeEvidenceElement
     */
    JobTitles: Array<MatchResumeEvidenceJobTitle>;
}
