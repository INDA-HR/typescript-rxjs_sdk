...
/**
 * @export
 * @interface ResumeCommonPublicMetadata
 */
export interface ResumeCommonPublicMetadata {
    /**
     * Language of the *Resume.Data* fields.
     * @type {string}
     * @memberof ResumeCommonPublicMetadata
     */
    Language?: ResumeCommonPublicMetadataLanguageEnum;
    /**
     * Date of creation. Format: \'YYYY-MM-DD[T]HH:MM[:SS[.ffffff]][Z or [±]HH[:]MM]]]\'.
     * @type {string}
     * @memberof ResumeCommonPublicMetadata
     */
    CreationDate: string;
    /**
     * Date of last update. Format: \'YYYY-MM-DD[T]HH:MM[:SS[.ffffff]][Z or [±]HH[:]MM]]]\'.
     * @type {string}
     * @memberof ResumeCommonPublicMetadata
     */
    LastModified: string;
 ...
 * @enum {string}
 */
export enum ResumeCommonPublicMetadataLanguageEnum {
    De = 'de',
    Pt = 'pt',
    Fr = 'fr',
    Es = 'es',
