...
/**
 * @export
 * @interface WeightedQueryTerm
 */
export interface WeightedQueryTerm {
    /**
     * The desired term(s) to search for.
     * @type {string}
     * @memberof WeightedQueryTerm
     */
    Term: string;
    /**
     * The language this term is expressed in.
     * @type {string}
     * @memberof WeightedQueryTerm
     */
    Language?: WeightedQueryTermLanguageEnum;
    /**
     * Optional. Must be between <code style=\'color: #333333; opacity: 0.9\'>0</code> (excluded) and <code style=\'color: #333333; opacity: 0.9\'>1</code>.
     * @type {number}
     * @memberof WeightedQueryTerm
     */
    Weight?: number;
 ...
 * @enum {string}
 */
export enum WeightedQueryTermLanguageEnum {
    It = 'it',
    En = 'en',
    Fr = 'fr',
    De = 'de',
