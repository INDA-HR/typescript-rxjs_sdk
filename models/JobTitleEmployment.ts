...
/**
 * @export
 * @interface JobTitleEmployment
 */
export interface JobTitleEmployment {
    /**
     * @type {BaseBenefitsValueModelStrictStr}
     * @memberof JobTitleEmployment
     */
     ...
     * @type {Array<BaseEmploymentsIndustry>}
     * @memberof JobTitleEmployment
     */
    Industries?: Array<BaseEmploymentsIndustry>;
    /**
     * @type {Array<BaseBenefitsValueModelStrictStr>}
     * @memberof JobTitleEmployment
     */
    FunctionalAreas?: Array<BaseBenefitsValueModelStrictStr>;
    /**
     * @type {Array<Activity>}
     * @memberof JobTitleEmployment
     */
