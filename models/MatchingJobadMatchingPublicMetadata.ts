...
/**
 * @export
 * @interface MatchingJobadMatchingPublicMetadata
 */
export interface MatchingJobadMatchingPublicMetadata {
    /**
     * Deprecated: use *src_lang* instead. Language of the *JobAd.Data* entity fields.
     * @type {string}
     * @memberof MatchingJobadMatchingPublicMetadata
     */
    Language?: MatchingJobadMatchingPublicMetadataLanguageEnum;
}
 ...
 * @enum {string}
 */
export enum MatchingJobadMatchingPublicMetadataLanguageEnum {
    It = 'it',
    En = 'en',
    Es = 'es',
    Pt = 'pt',
