...
/**
 * @export
 * @interface GetStandardDataResponse
 */
export interface GetStandardDataResponse {
    /**
     * @type {Array<StandardDataItem>}
     * @memberof GetStandardDataResponse
     */
    Data: Array<StandardDataItem>;
}
