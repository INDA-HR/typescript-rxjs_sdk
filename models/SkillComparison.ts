...
export interface SkillComparison {
    /**
     * This field shows the origin skill according with the ESCO classification.
     * @type {string}
     * @memberof SkillComparison
     */
    OriginSkill?: string;
    /**
     * This field shows the destination skill according with the ESCO classification.
     * @type {string}
     * @memberof SkillComparison
     */
    DestinationSkill?: string;
    /**
     * This field shows the similarity between the origin and destination skill.
     * @type {number}
     * @memberof SkillComparison
     */
    Similarity?: number;
