...
/**
 * @export
 * @interface FinalGradeValue
 */
export interface FinalGradeValue {
    /**
     * A non-numerical or text representation of the score.
     * @type {string}
     * @memberof FinalGradeValue
     */
    ScoreText?: string;
    /**
     * A numerical record of the marks allotted to an individual in measuring their abilities.
     * @type {number}
     * @memberof FinalGradeValue
     */
    ScoreNumeric?: number;
