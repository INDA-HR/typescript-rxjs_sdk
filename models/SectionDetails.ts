...
export interface SectionDetails {
    /**
     * Language of this section. If missing, the language of the job title is assumed to correspond to the language of the job advert.
     * @type {string}
     * @memberof SectionDetails
     */
    Language?: SectionDetailsLanguageEnum;
    /**
 ...
 * @enum {string}
 */
export enum SectionDetailsLanguageEnum {
    De = 'de',
    Pt = 'pt',
    Fr = 'fr',
    Es = 'es',
