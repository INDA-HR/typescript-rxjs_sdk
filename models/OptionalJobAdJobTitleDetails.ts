...
/**
 * @export
 * @interface OptionalJobAdJobTitleDetails
 */
export interface OptionalJobAdJobTitleDetails {
    /**
     * @type {Array<TextPosition>}
     * @memberof OptionalJobAdJobTitleDetails
     */
    ...
    /**
     *  Weight of the job title. Used for mathing purposes.
     * @type {number}
     * @memberof OptionalJobAdJobTitleDetails
     */
    Weight?: number;
