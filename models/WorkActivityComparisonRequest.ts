...
/**
 * @export
 * @interface WorkActivityComparisonRequest
 */
export interface WorkActivityComparisonRequest {
    /**
     * Origin occupation involved in the considered career transition.
     * @type {string}
     * @memberof WorkActivityComparisonRequest
     */
    ...
    /**
     * Granularity level of ESCO work activities to consider.
     * @type {number}
     * @memberof WorkActivityComparisonRequest
     */
    ESCOLevel: number;
