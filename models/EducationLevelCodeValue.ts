...
/**
 * @export
 * @interface EducationLevelCodeValue
 */
export interface EducationLevelCodeValue {
    /**
     * Qualification level according to the [EQF](https://en.wikipedia.org/wiki/European_Qualifications_Framework).
     * @type {number}
     * @memberof EducationLevelCodeValue
     */
    EQF?: number;
}
