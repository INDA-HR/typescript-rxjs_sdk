...
/**
 * @export
 * @interface OptionalEscoMatchDetails
 */
export interface OptionalEscoMatchDetails {
    /**
     * This field shows the preprocessed tokens of the input given by the user.
     * @type {Array<any>}
     * @memberof OptionalEscoMatchDetails
     */
    PreprocessedInput?: Array<any>;
    /**
     * This field shows the preprocessed tokens of the most similar ESCO classification.
     * @type {Array<any>}
     * @memberof OptionalEscoMatchDetails
     */
    PreprocessedESCOClassification?: Array<any>;
}
