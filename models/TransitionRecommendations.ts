...
/**
 * @export
 * @interface TransitionRecommendations
 */
export interface TransitionRecommendations {
    /**
     * @type {ESCOOccupationValue}
     * @memberof TransitionRecommendations
     */
    ESCOClassification?: ESCOOccupationValue;
    /**
     * This field shows the list of transition recommendations.
     * @type {Array<TransitionRecommendationValue>}
     * @memberof TransitionRecommendations
     */
    TransitionRecommendation?: Array<TransitionRecommendationValue>;
}
