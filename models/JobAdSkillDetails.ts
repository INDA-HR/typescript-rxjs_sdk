...
/**
 * @export
 * @interface JobAdSkillDetails
 */
export interface JobAdSkillDetails {
    /**
     * @type {Array<TextPosition>}
     * @memberof JobAdSkillDetails
     */
     ...
     * @memberof JobAdSkillDetails
     */
    Category?: JobAdSkillDetailsCategoryEnum;
    /**
 ...
 * @enum {string}
 */
export enum JobAdSkillDetailsCategoryEnum {
    Hard = 'hard',
    Soft = 'soft',
    It = 'IT',
    Language = 'language'
