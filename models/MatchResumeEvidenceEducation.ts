...
/**
 * @export
 * @interface MatchResumeEvidenceEducation
 */
export interface MatchResumeEvidenceEducation {
    /**
     * @type {HighestEducationTitle}
     * @memberof MatchResumeEvidenceEducation
     */
    ...
    /**
     * Normalized score. Min Score is 0 and Max Score is 1.
     * @type {number}
     * @memberof MatchResumeEvidenceEducation
     */
    Score: number;
