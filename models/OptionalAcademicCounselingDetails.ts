...
/**
 * @export
 * @interface OptionalAcademicCounselingDetails
 */
export interface OptionalAcademicCounselingDetails {
    /**
     * Academic Counseling description.
     * @type {string}
     * @memberof OptionalAcademicCounselingDetails
     */
