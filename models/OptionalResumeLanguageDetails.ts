...
/**
 * @export
 * @interface OptionalResumeLanguageDetails
 */
export interface OptionalResumeLanguageDetails {
    /**
     * @type {Array<TextPosition>}
     * @memberof OptionalResumeLanguageDetails
     */
    TextPositions?: Array<TextPosition>;
    /**
     * @type {string}
     * @memberof OptionalResumeLanguageDetails
     */
    RawValue?: string;
    /**
     * @type {Array<TextDetails>}
     * @memberof OptionalResumeLanguageDetails
     */
    RawValues?: Array<TextDetails>;
    /**
     * @type {boolean}
     * @memberof OptionalResumeLanguageDetails
     */
    ...
    EntityType?: string;
    /**
     * A descriptive language proficiency level. E.g.: \'Good\', \'Excellent\'.
     * @type {string}
     * @memberof OptionalResumeLanguageDetails
     */
    ...
    /**
     * Whether the language is primary or not.
     * @type {boolean}
     * @memberof OptionalResumeLanguageDetails
     */
    IsPrimary?: boolean;
