...
export interface ApplicationStatusRequest {
    /**
     * The date in which the status changed. Format: \'YYYY-MM-DD\' or \'YYYY-MM-DD[T]HH:MM[:SS[.ffffff]][Z or [±]HH[:]MM]]]\'.
     * @type {string}
     * @memberof ApplicationStatusRequest
     */
    Date: string;
    /**
     * A brief description indicating the reason why the state has changed. E.g.: the status \'DISQUALIFIED\' could be used both to exclude candidates which are unsuitable or those who refused the job offer.
     * @type {string}
     * @memberof ApplicationStatusRequest
     */
    Description?: string;
     ...
     * @memberof ApplicationStatusRequest
     */
    Status: ApplicationStatusRequestStatusEnum;
}
 ...
 * @enum {string}
 */
export enum ApplicationStatusRequestStatusEnum {
    Applied = 'APPLIED',
    Sourced = 'SOURCED',
    Screen = 'SCREEN',
    Interview = 'INTERVIEW',
