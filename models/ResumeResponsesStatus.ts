...
/**
 * @export
 * @interface ResumeResponsesStatus
 */
export interface ResumeResponsesStatus {
    /**
     * ID of the requested resume.
     * @type {string}
     * @memberof ResumeResponsesStatus
     */
    ID: string;
    /**
     * Insights on the requested operation result.
     * @type {string}
     * @memberof ResumeResponsesStatus
     */
    AnalysisStatus?: string;
    /**
     * ID of the already present resume (if any).
     * @type {string}
     * @memberof ResumeResponsesStatus
     */
    IndexedID?: string;
