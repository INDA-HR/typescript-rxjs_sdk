...
/**
 * @export
 * @interface ClassificationMappingOnetResponse
 */
export interface ClassificationMappingOnetResponse {
    /**
     * This field shows the O*NET occupation code.
     * @type {string}
     * @memberof ClassificationMappingOnetResponse
     */
    ONETCode: string;
    /**
     * This field shows the O*NET occupation.
     * @type {string}
     * @memberof ClassificationMappingOnetResponse
     */
