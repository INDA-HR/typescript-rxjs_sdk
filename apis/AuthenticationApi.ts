...
export class AuthenticationApi extends BaseAPI {
     ...
     * Log In
     */
    logInPOST({ loginData }: LogInPOSTRequest): Observable<TokenResponse>
    logInPOST({ loginData }: LogInPOSTRequest, opts?: OperationOpts): Observable<AjaxResponse<TokenResponse>>
    logInPOST({ loginData }: LogInPOSTRequest, opts?: OperationOpts): Observable<TokenResponse | AjaxResponse<TokenResponse>> {
        throwIfNullOrUndefined(loginData, 'loginData', 'logInPOST');
