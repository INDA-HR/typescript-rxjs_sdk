...
export interface SimilarJobtitlesGETRequest {
    query: string;
    size?: number;
    minScore?: number;
    srcLang?: SimilarJobtitlesGETSrcLangEnum;
    dstLang?: SimilarJobtitlesGETDstLangEnum;
}
...
export class OccupationsApi extends BaseAPI {
     ...
     * Similar JobTitles
     */
    similarJobtitlesGET({ query: queryAlias, size, minScore, srcLang, dstLang }: SimilarJobtitlesGETRequest): Observable<SimilarEntitiesResponse>
    similarJobtitlesGET({ query: queryAlias, size, minScore, srcLang, dstLang }: SimilarJobtitlesGETRequest, opts?: OperationOpts): Observable<AjaxResponse<SimilarEntitiesResponse>>
    similarJobtitlesGET({ query: queryAlias, size, minScore, srcLang, dstLang }: SimilarJobtitlesGETRequest, opts?: OperationOpts): Observable<SimilarEntitiesResponse | AjaxResponse<SimilarEntitiesResponse>> {
        throwIfNullOrUndefined(queryAlias, 'queryAlias', 'similarJobtitlesGET');
 ...
 * @enum {string}
 */
export enum SimilarJobtitlesGETSrcLangEnum {
    It = 'it',
    En = 'en',
    Es = 'es',
    Pt = 'pt',
 ...
 * @enum {string}
 */
export enum SimilarJobtitlesGETDstLangEnum {
    It = 'it',
    En = 'en',
    Es = 'es',
    Pt = 'pt',
