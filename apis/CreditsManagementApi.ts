...
export interface SearchCreditsPOSTRequest {
    indexname: string;
    searchCreditsRequest: SearchCreditsRequest;
}

/**
 * no description
 */
export class CreditsManagementApi extends BaseAPI {
     ...
     * Search Credits
     */
    searchCreditsPOST({ indexname, searchCreditsRequest }: SearchCreditsPOSTRequest): Observable<IndexCreditsInfo>
    searchCreditsPOST({ indexname, searchCreditsRequest }: SearchCreditsPOSTRequest, opts?: OperationOpts): Observable<AjaxResponse<IndexCreditsInfo>>
    searchCreditsPOST({ indexname, searchCreditsRequest }: SearchCreditsPOSTRequest, opts?: OperationOpts): Observable<IndexCreditsInfo | AjaxResponse<IndexCreditsInfo>> {
        throwIfNullOrUndefined(indexname, 'indexname', 'searchCreditsPOST');
        throwIfNullOrUndefined(searchCreditsRequest, 'searchCreditsRequest', 'searchCreditsPOST');
        ...
        return this.request<IndexCreditsInfo>({
            url: '/hr/v2/index/{indexname}/credits/'.replace('{indexname}', encodeURI(indexname)),
            method: 'POST',
            headers,
