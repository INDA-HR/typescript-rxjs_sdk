...
export interface ClearSearchResultsDELETERequest {
    indexname: string;
    searchId: string;
}
 ...
 * no description
 */
export class ClearCacheApi extends BaseAPI {
     ...
     */
    clearSearchResultsDELETE({ indexname, searchId }: ClearSearchResultsDELETERequest): Observable<CacheDeletion>
    clearSearchResultsDELETE({ indexname, searchId }: ClearSearchResultsDELETERequest, opts?: OperationOpts): Observable<AjaxResponse<CacheDeletion>>
    clearSearchResultsDELETE({ indexname, searchId }: ClearSearchResultsDELETERequest, opts?: OperationOpts): Observable<CacheDeletion | AjaxResponse<CacheDeletion>> {
        throwIfNullOrUndefined(indexname, 'indexname', 'clearSearchResultsDELETE');
        throwIfNullOrUndefined(searchId, 'searchId', 'clearSearchResultsDELETE');
        ...
        return this.request<CacheDeletion>({
            url: '/hr/v2/index/{indexname}/resumes/search/scroll/'.replace('{indexname}', encodeURI(indexname)),
            method: 'DELETE',
            headers,
            query,
        }, opts?.responseOpts);
