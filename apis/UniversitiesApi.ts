...
export interface GetUniversityGETRequest {
    universityId: string;
    minimal?: boolean;
}

export interface UniversityAutocompleteGETRequest {
    term: string;
    size?: number;
    tokenOrder?: UniversityAutocompleteGETTokenOrderEnum;
    fuzzy?: boolean;
    city?: Array<string>;
    country?: Array<string>;
    countryCode?: Array<UniversityAutocompleteGETCountryCodeEnum>;
    lat?: number;
    lon?: number;
    pivot?: number;
 ...
 * no description
 */
export class UniversitiesApi extends BaseAPI {

    /**
     * This method retrieves the *university\'* full data through a UUID *university_id*.
     * Get University
     */
    getUniversityGET({ universityId, minimal }: GetUniversityGETRequest): Observable<GetUniversityResponse>
    getUniversityGET({ universityId, minimal }: GetUniversityGETRequest, opts?: OperationOpts): Observable<AjaxResponse<GetUniversityResponse>>
    getUniversityGET({ universityId, minimal }: GetUniversityGETRequest, opts?: OperationOpts): Observable<GetUniversityResponse | AjaxResponse<GetUniversityResponse>> {
        throwIfNullOrUndefined(universityId, 'universityId', 'getUniversityGET');
        ...
        if (minimal != null) { query['minimal'] = minimal; }

        return this.request<GetUniversityResponse>({
            url: '/hr/v2/university/{university_id}/'.replace('{university_id}', encodeURI(universityId)),
            method: 'GET',
            headers,
            query,
        }, opts?.responseOpts);
     ...
     */
    universityAutocompleteGET({ term, size, tokenOrder, fuzzy, city, country, countryCode, lat, lon, pivot, includeBranches }: UniversityAutocompleteGETRequest): Observable<UniversityAutocompleteResponse>
    universityAutocompleteGET({ term, size, tokenOrder, fuzzy, city, country, countryCode, lat, lon, pivot, includeBranches }: UniversityAutocompleteGETRequest, opts?: OperationOpts): Observable<AjaxResponse<UniversityAutocompleteResponse>>
    universityAutocompleteGET({ term, size, tokenOrder, fuzzy, city, country, countryCode, lat, lon, pivot, includeBranches }: UniversityAutocompleteGETRequest, opts?: OperationOpts): Observable<UniversityAutocompleteResponse | AjaxResponse<UniversityAutocompleteResponse>> {
        throwIfNullOrUndefined(term, 'term', 'universityAutocompleteGET');
        ...
        if (pivot != null) { query['pivot'] = pivot; }
        if (includeBranches != null) { query['include_branches'] = includeBranches; }

        return this.request<UniversityAutocompleteResponse>({
 ...
 * @enum {string}
 */
export enum UniversityAutocompleteGETTokenOrderEnum {
    Any = 'any',
 ...
 * @enum {string}
 */
export enum UniversityAutocompleteGETCountryCodeEnum {
    Aw = 'AW',
    Af = 'AF',
    Ao = 'AO',
    Ai = 'AI',
